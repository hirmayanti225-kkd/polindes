...
<body style="background-color: #D3D3D3;">
    ...
    <div class="container text-center">
        <br>
        <h1>Daftar Kunjungan Polindes Kabar</h1>
    </div>
    <a href="<?php echo base_url('index.php/welcome/form_kunjungan') ?>" class="btn btn-success mt-2"
        style="width: 100%;">Buat Kunjungan Baru</a>
    <table class="table mt-2">
        <thead>
            <tr>
                <th scope="col">No</th>
                <th scope="col">Nama Ibu dan Suami</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo base_url('index.php/welcome/update_kunjungan/' . $item->id) ?>"
                        class="btn btn-warning">Edit</a>
                    <a href="<?php echo base_url('index.php/welcome/delete/' . $item->id) ?>"

...
<body style="background-color: #D3D3D3;">
    ...
    <div class="container wy-text-center mb-5">
        ...
        <form method="post" action="<?= base_url('index.php/welcome/form_kunjungan') ?>">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="ibu_suami"
                    placeholder="Nama Ibu dan Suami">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="usia" placeholder="Usia">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Diameter</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="diameter" placeholder="Diameter">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Tanggal</label>
                <input type="date" class="form-control" id="exampleInputEmail1" name="tanggal" placeholder="Tanggal">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">BT</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="bt" placeholder="BT">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">BB</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="bb" placeholder="BB">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">TB</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="tb" placeholder="TB">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">TD</label></label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="td" placeholder="TD">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Keluhan</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="keluhan" placeholder="Keluhan">
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Lab</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="lab" placeholder="Lab">
            </div>
            <div class="mb-3">

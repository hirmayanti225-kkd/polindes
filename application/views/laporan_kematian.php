...
<body style="background-color: #D3D3D3;">
    ...
    <div class="container">
        <br>
        <h4 class="text-center mt-3">LAPORAN KEMATIAN BAYI (NEONATAL USIA 0-28 HARI)</h4>
        <h4 class="text-center">PUSKESMAS SAKRA KABUPATEN LOMBOK TIMUR PROVINSI NUSA TENGGARA BARAT</h4>
        ...
        <table class="table">
            ...
            <tbody class="table-secondary text-center">
                ...
                <tr>
                    ...
                    <td>Kumulatif</td>
                    <td></td>
                    <td>TOTAL S/D BLN ini</td>
                    <td>Bulan ini</td>
                    <td></td>
                    <td>Kumulatif</td>
                    <td></td>
                    <td>TOTAL S/DA BLN ini</td>
                    <td>Bulan ini</td>
                    <td></td>
                    <td>Kumulatif</td>
                    <td></td>

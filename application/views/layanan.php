...
<body style="background-color: #D3D3D3;">
    ...
    <div class="container mb-5">
        <br>
        <h1 class="text-center">Jenis Pelayanan di Polindes Kabar</h1>
        <table class="table mt-5">
            <thead>
                <tr class="table-success">
                    <th scope="col" class="text-center">PEMERIKSAAN KEHAMILAN (ANC)</th>
                </tr>
                <tr class="table-success">
                    <th scope="col" class="text-center">PERTOLONGAN PERSALINAN NORMAL</th>
                </tr>
                <tr class="table-success">
                    <th scope="col" class="text-center">PELAYANAN BAYI BARU LAHIR DAN NIFAS</th>
                </tr>
                <tr class="table-success">
                    <th scope="col" class="text-center">PELAYANAN KESEHATAN BAYI DAN BALITA</th>
                </tr>
                <tr class="table-success">
                    <th scope="col" class="text-center">PELAYANAN KELUARGA BERENCANA (KB)</th>
                </tr>
                <tr class="table-success">
                    <th scope="col" class="text-center">PELAYANAN KESEHATAN REPRODUKSI</th>
                </tr>
            </thead>
